defmodule Explorer.Application do
  ...
  defp configurable_children do
    configurable_children_set =
      [
        configure_mode(Explorer.Repo.Replica1, :api),
        configure_mode(Explorer.SmartContract.SolcDownloader, :api),
        configure_mode(Explorer.SmartContract.VyperDownloader, :api),
        configure_mode({Admin.Recovery, [[], [name: Admin.Recovery]]}, :api),
        ...
        configure_mode_dependent_process(Explorer.Chain.Cache.Counters.AverageBlockTime, :api),
        ...
        configure_mode(Explorer.Migrator.SwitchPendingOperations, :indexer),
  ...
  defp configure_mode(process, mode) do
